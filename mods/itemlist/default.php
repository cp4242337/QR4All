...
echo '<th>Title</th><th width="250">Type</th>';
...
foreach ($items as $d) { 
	...
	if ($user->lvl > 1) {
		if (in_array($d->item_type,$optsqs)) echo '<a href="#" onclick="return listItemTask(\'cb'.$count.'\',\'options\')" title="Item Options"><img src="images/items.png" border="0" alt="Item Options" /></a> ';
