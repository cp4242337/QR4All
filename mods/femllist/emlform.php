...
<tr><td align="right" class="ftitle">To Name:</td><td class="ffield"><input name="eml_toname" class="field required maxLength:100" type="text" title="EMail to name must be 5-100 characters"  value="<?php echo $emlinfo->eml_toname; ?>"></td></tr>
<tr><td align="right" class="ftitle">To EMail:</td><td class="ffield"><input name="eml_toaddr" class="field required maxLength:100" type="text" title="EMail to address must be 5-100 characters"  value="<?php echo $emlinfo->eml_toaddr; ?>"></td></tr>
